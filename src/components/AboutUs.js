            ...
            <div className={`about-us ${isMobile ? 'mobile' : 'desktop'}`}>
                <div className="about-us-text">
                    ...
                    <p className="about-us-description">
                       Indulge in luxury at Brickspoint Boutique ApartHotel, nestled in Asokoro, Abuja. Immerse yourself in chic comfort just moments from the CBD. Enjoy personalized service in a vibrant local near embassies, ensuring an unforgettable stay. 
                    </p>
