...
import Room from '../assets/images/hotelimage/room.jpg'
import { rooms } from './HotelImages'
import ArrowForwardIosIcon from '@mui/icons-material/ArrowForwardIos';
import ArrowBackIosNewIcon from '@mui/icons-material/ArrowBackIosNew';
import { useNavigate } from 'react-router-dom';
import BoyIcon from '@mui/icons-material/Boy';
import Abuja from '../assets/images/abuja.jpeg'
...
function Rooms() {
    ...
    return (
        <div style={{ width: '100%', height: 'auto', marginTop: 100, marginBottom: 100 }}>
            <div style={{ height: 900, zIndex: -1, position: imagePosition }}>
                <img src={Abuja} alt="Abuja" style={{ width: '100%', height: '100%', objectFit: 'cover' }} ref={imageRef} />
            </div>
            <div style={{ display: 'flex', marginLeft: 15, alignItems: 'center' }}>
                <div style={{ fontSize: 65, color: '#000', fontFamily: 'FuturaLight' }}>Stay</div>
                <div style={{ marginLeft: 20, marginTop: 0, display: 'flex', alignItems: 'center' }}>
                    <div style={{ fontSize: 20, fontFamily: 'FuturaLight', color: '#554139' }}>View all stays</div>
                    <div><ArrowForwardIosIcon style={{ fontSize: 25, color: '#554139' }} /></div>
                </div>
            </div>
            <div className="room-card-container" style={{ width: '100%', overflowX: 'auto', display: 'flex', justifyContent: 'flex-start', marginTop: 20 }}>
